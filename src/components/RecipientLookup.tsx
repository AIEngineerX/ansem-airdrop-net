    ...
    <div className="rounded-2xl border border-white/[0.08] bg-[#0a0a0b] p-4 sm:p-5">
      ...
      {hit && hit !== "miss" && (
        <div className="mt-3 rounded-xl border border-[var(--accent)]/30 bg-[var(--accent)]/[0.06] p-3 text-sm">
          <p className="text-zinc-200">Airdropped <span className="tabular font-mono font-semibold">{fmt(hit.totalAnsemUi)} ANSEM</span> in {hit.transferCount} airdrop{hit.transferCount === 1 ? "" : "s"}.</p>
